...
public class AppsShareAuthPhoneActivity extends AppsRootActivity implements View.OnTouchListener {
    final Handler i;
    ...
    static {
        AppsShareAuthPhoneActivity.j = AppsShareAuthPhoneActivity.class.hashCode();
    }

    public AppsShareAuthPhoneActivity() {
        this.p = false;
        this.q = false;
        this.r = false;
        this.u = false;
        this.v = new BroadcastReceiver() {
            ...
            public void onReceive(Context arg2, Intent arg3) {
                ...
                if(v2.equals("NOTIFICATION_DIDCONNECT")) {
                    AppsShareAuthPhoneActivity.e(AppsShareAuthPhoneActivity.this);
                    return;
                }

                if(v2.equals("NOTIFICATION_DISCONNECT")) {
                    if(AppsShareAuthPhoneActivity.e(AppsShareAuthPhoneActivity.this)) {
                        AppsShareAuthPhoneActivity.this.b(true);
                        return;
                    }
                }
                else if(v2.equals("NOTIFICATION_SYN_USER_INFO_FINISH")) {
                    if(AppsShareAuthPhoneActivity.e(AppsShareAuthPhoneActivity.this)) {
                        AppsShareAuthPhoneActivity.this.b(false);
                        AppsShareAuthPhoneActivity.this.i.removeMessages(0x6F);
                        Intent v0 = AppsShareAuthPhoneActivity.this.getIntent();
                        AppsShareAuthPhoneActivity.this.setResult(-1, v0);
                        AppsShareAuthPhoneActivity.this.finish();
                        return;
                    }
                }
        ...
        this.i = new Handler() {
            ...
            public void handleMessage(Message arg4) {
                if(arg4.what == 0x6F) {
                    Intent v4 = new Intent(AppsShareAuthPhoneActivity.this, AppsDeviceListPhoneActivity.class);
                    AppsShareAuthPhoneActivity.this.startActivity(v4);
    ...
    static AlertDialog a(AppsShareAuthPhoneActivity arg0) {
        return arg0.t;
    }

    static AlertDialog a(AppsShareAuthPhoneActivity arg0, AlertDialog arg1) {
        arg0.t = arg1;
        return arg1;
    }
    ...
    static void a(AppsShareAuthPhoneActivity arg0, int arg1) {
        arg0.a(arg1);
    }

    static boolean a(AppsShareAuthPhoneActivity arg0, boolean arg1) {
        arg0.u = arg1;
        return arg1;
    }
    ...
    static boolean b(AppsShareAuthPhoneActivity arg0) {
        return arg0.u;
    }
    ...
    static ProgressBar c(AppsShareAuthPhoneActivity arg0) {
        return arg0.o;
    }

    static boolean d(AppsShareAuthPhoneActivity arg0) {
        return arg0.p;
    }

    static boolean e(AppsShareAuthPhoneActivity arg0) {
        return arg0.r;
    }
    ...
    public void l() {
        ...
        m.a(new a() {
            ...
            public void a(Object arg10) {
                int v1 = 0;
                try {
                    AppsShareAuthPhoneActivity.this.f();
                    if(arg10 == null) {
                        AppsShareAuthPhoneActivity.this.c("FAILED TO GET ACCESS TOKEN");
                        return;
                    }
                    ...
                    int v5 = AppsRunner.get(AppsShareAuthPhoneActivity.this).getPref_CurrentUserID(AppsShareAuthPhoneActivity.this);
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).h(v4, v5 + "");
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).b(v2, v5 + "");
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).e(v3, v5 + "");
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).a(v5 + "", apps.c.d.a(v10_2, 0).intValue());
                    j.a("==access_token==", v2 + " |");
                    if(AppsShareAuthPhoneActivity.d(AppsShareAuthPhoneActivity.this)) {
                        AppsShareAuthPhoneActivity.this.o();
                    }
                    else {
                        AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this, 0);
                        AppsShareAuthPhoneActivity.this.onBackPressed();
                        goto label_79;
                        AppsShareAuthPhoneActivity.this.c("FAILED TO GET ACCESS TOKEN");
                        return;
                    }
            ...
            public void a(Object arg10) {
                try {
                    ...
                    if(arg10 != null) {
                        ...
                        String v10_2 = v10_1.getExpires_in();
                        int v5 = AppsRunner.get(AppsShareAuthPhoneActivity.this).getPref_CurrentUserID(AppsShareAuthPhoneActivity.this);
                        ShareFitness.get(AppsShareAuthPhoneActivity.this).setPrefsMyFitnessPalTokenKey(v2, v5 + "");
                        ShareFitness.get(AppsShareAuthPhoneActivity.this).d(v3, v5 + "");
                        ShareFitness.get(AppsShareAuthPhoneActivity.this).setPrefsMFP_UserId(v4, v5 + "");
                        ShareFitness.get(AppsShareAuthPhoneActivity.this).b(v4 + "", apps.c.d.a(v10_2, 0).intValue());
                        j.a("==access_token==", v2 + " | " + v4);
                        if(AppsShareAuthPhoneActivity.d(AppsShareAuthPhoneActivity.this)) {
                            AppsShareAuthPhoneActivity.this.p();
                            return;
                        }

                        AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this, 1);
                        AppsShareAuthPhoneActivity.this.onBackPressed();
                        return;
                    }
        ...
        m.a(new a() {
            ...
            public void a(Object arg10) {
                ...
                try {
                    ...
                    String v10_2 = v10_1.getExpires_in();
                    int v5 = AppsRunner.get(AppsShareAuthPhoneActivity.this).getPref_CurrentUserID(AppsShareAuthPhoneActivity.this);
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).c(v2, v5 + "");
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).f(v3, v5 + "");
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).i(v4, v5 + "");
                    ShareFitness.get(AppsShareAuthPhoneActivity.this).c(v4 + "", apps.c.d.a(v10_2, 0).intValue());
                    j.a("==access_token==", v2 + " | " + v4);
                    if(AppsShareAuthPhoneActivity.d(AppsShareAuthPhoneActivity.this)) {
                        AppsShareAuthPhoneActivity.this.q();
                    }
                    else {
                        AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this, 2);
                        AppsShareAuthPhoneActivity.this.onBackPressed();
                        goto label_81;
                        AppsShareAuthPhoneActivity.this.c("FAILED TO GET ACCESS TOKEN");
                        return;
    ...
    public void onCreate(Bundle arg2) {
        ...
        this.setContentView(0x7F090055);  // layout:activity_share_auth_phone
        apps.c.b.a(this);
    ...
    private void t() {
        ...
        this.n.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView arg5, String arg6) {
                ...
                AppsShareAuthPhoneActivity.c(AppsShareAuthPhoneActivity.this).setVisibility(8);
                int v0_1 = ShareFitness.get(AppsShareAuthPhoneActivity.this).a();
                if(!apps.c.d.strNotEmpty(arg6)) {
                    ...
                    if(arg6.indexOf("https://johnsondemo.herokuapp.com/authorization_callback/") == 0 && v0_1 == 0) {
                        int v0_2 = AppsRunner.get(AppsShareAuthPhoneActivity.this).getPref_CurrentUserID(AppsShareAuthPhoneActivity.this);
                        String v1 = arg6.replaceAll("https://johnsondemo.herokuapp.com/authorization_callback/\\?code=", "");
                        ShareFitness.get(AppsShareAuthPhoneActivity.this).j(v1, v0_2 + "");
                        j.a("==code==", v1 + " |");
                        if(apps.c.d.strNotEmpty(v1)) {
                            apps.views.b.a(AppsShareAuthPhoneActivity.this, "FAILED TO GET ACCESS TOKEN");
                        }
                        else {
                            AppsShareAuthPhoneActivity.this.l();
                        }
                    }
                    else if(v2 == 0 && v0_1 == 1) {
                        String v0_3 = arg6.replaceAll("https://johnsondemo.herokuapp.com/authorization_callback/\\?code=", "");
                        int v1_1 = AppsRunner.get(AppsShareAuthPhoneActivity.this).getPref_CurrentUserID(AppsShareAuthPhoneActivity.this);
                        ShareFitness.get(AppsShareAuthPhoneActivity.this).j(v0_3, v1_1 + "");
                        j.a("==code==", v0_3 + " |");
                        if(apps.c.d.strNotEmpty(v0_3)) {
                            apps.views.b.a(AppsShareAuthPhoneActivity.this, "FAILED TO GET ACCESS TOKEN");
                        }
                        else {
                            AppsShareAuthPhoneActivity.this.m();
                        }
                    }
                    else if(v3 == 0 && v0_1 == 2) {
                        ...
                        int v1_3 = AppsRunner.get(AppsShareAuthPhoneActivity.this).getPref_CurrentUserID(AppsShareAuthPhoneActivity.this);
                        ShareFitness.get(AppsShareAuthPhoneActivity.this).j(v0_4, v1_3 + "");
                        j.a("==code==", v0_4 + " |");
                        if(apps.c.d.strNotEmpty(v0_4)) {
                            apps.views.b.a(AppsShareAuthPhoneActivity.this, "FAILED TO GET ACCESS TOKEN");
                        }
                        else {
                            AppsShareAuthPhoneActivity.this.n();
                        }
                    }
                }
            ...
            public void onPageStarted(WebView arg4, String arg5, Bitmap arg6) {
                ...
                AppsShareAuthPhoneActivity.c(AppsShareAuthPhoneActivity.this).setVisibility(0);
            ...
            public void onReceivedSslError(WebView arg2, SslErrorHandler arg3, SslError arg4) {
                if(AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this) == null && !AppsShareAuthPhoneActivity.b(AppsShareAuthPhoneActivity.this)) {
                    AlertDialog.Builder v2 = new AlertDialog.Builder(AppsShareAuthPhoneActivity.this);
                    ...
                    v2.setPositiveButton("continue", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg1, int arg2) {
                            arg3.proceed();
                            AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this, true);
                            AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this, null);
                        }
                    });
                    ...
                    AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this, v2_1);
                    AppsShareAuthPhoneActivity.a(AppsShareAuthPhoneActivity.this).show();
                    return;
                }

                if(AppsShareAuthPhoneActivity.b(AppsShareAuthPhoneActivity.this)) {
                    arg3.proceed();
                }
            }
