...
public class AppsDeviceListActivity extends AppsRootActivity implements View.OnTouchListener, AdapterView.OnItemClickListener {
            ...
            public void onReceive(Context arg3, Intent arg4) {
                ...
                if(!v3.equals("NOTIFICATION_DID_FIND_DEVICE") && (!v3.equals("NOTIFICATION_STATE_DIDCONNECTSTATE") && !v3.equals("NOTIFICATION_DIDCONNECT"))) {
                    if(v3.equals("NOTIFICATION_DISCONNECT")) {
                        AppsDeviceListActivity.a(AppsDeviceListActivity.this, 0);
                    }
                        ...
                        if(v3.equals("NOTIFICATION_DID_GET_MACHINE_INFO_SUCCESS")) {
                            j.a("====收到machine info===", AppsDeviceListActivity.b(AppsDeviceListActivity.this) + " |");
                            if(!AppsDeviceListActivity.b(AppsDeviceListActivity.this)) {
                                return;
                            }

                            int v3_1 = (int)(((Integer)arg4.getExtras().get("Extra_Key_Workout_State")));
                            AppsDeviceListActivity.b(AppsDeviceListActivity.this, v3_1);
                            return;
                        }
                        ...
                        if(AppsDeviceListActivity.c(AppsDeviceListActivity.this)) {
                            j.a("===同步完成===", "要进行跳转动作 : " + AppsDeviceListActivity.b(AppsDeviceListActivity.this) + "  状态：" + AppsDeviceListActivity.d(AppsDeviceListActivity.this));
                            if(AppsDeviceListActivity.b(AppsDeviceListActivity.this)) {
                                goto label_86;
                            }

                            if(!AppsDeviceListActivity.e(AppsDeviceListActivity.this)) {
                                AppsRunner.get(AppsDeviceListActivity.this).clear();
                                AppsDeviceListActivity.this.finish();
                                return;
                            label_86:
                                AppsDeviceListActivity.f(AppsDeviceListActivity.this);
                                j.a("====bluetoothReConnectedLock 1===", AppsDeviceListActivity.g(AppsDeviceListActivity.this) + " |");
                                if(AppsDeviceListActivity.d(AppsDeviceListActivity.this) != 1) {
                                ...
                                if(AppsDeviceListActivity.g(AppsDeviceListActivity.this) > 1) {
                                    return;
                                }

                                v3_2 = new Intent(AppsDeviceListActivity.this, Apps321Activity.class);
                                AppsDeviceListActivity.this.startActivity(v3_2);
                                AppsDeviceListActivity.this.finish();
                                return;
                            label_112:
                        ...
                        label_184:
                            if(v3.equals("NOTIFICATION_START_SYN_USER_INFO")) {
                                AppsDeviceListActivity.c(AppsDeviceListActivity.this);
                            }
                        }
                ...
                AppsDeviceListActivity.a(AppsDeviceListActivity.this).notifyDataSetChanged();
            }
        };
        this.u = 0;
    }

    static int a(AppsDeviceListActivity arg0, int arg1) {
        arg0.u = arg1;
        return arg1;
    }

    static b a(AppsDeviceListActivity arg0) {
        return arg0.l;
    }
    ...
    static int b(AppsDeviceListActivity arg0, int arg1) {
        arg0.q = arg1;
        return arg1;
    }

    static boolean b(AppsDeviceListActivity arg0) {
        return arg0.p;
    }

    static boolean c(AppsDeviceListActivity arg0) {
        return arg0.o;
    }

    static int d(AppsDeviceListActivity arg0) {
        return arg0.q;
    }

    static boolean e(AppsDeviceListActivity arg0) {
        return arg0.s;
    }
    ...
    static int f(AppsDeviceListActivity arg2) {
        int v0 = arg2.u;
        arg2.u = v0 + 1;
        return v0;
    }

    static int g(AppsDeviceListActivity arg0) {
        return arg0.u;
    }
    ...
    public void onCreate(Bundle arg3) {
        ...
        this.a(0x7F09001E, 0x7F09001F, 0x7F090020);  // layout:activity_device_list
        ...
        if((AppsRunnerConnector.get(this).isConnected()) && (v3.n())) {
            this.startActivity(new Intent(this, AppsSettingActivity.class));
            this.finish();
        }
    }
            ...
            v3.a(this.getResources().getString(0x7F0B000A), new DialogInterface.OnClickListener() {  // string:STR_ALERT_TIP_CONFIRM "Yes"
                ...
                public void onClick(DialogInterface arg1, int arg2) {
                    ...
                    if(((boolean)(((int)v2)))) {
                        ...
                        AppsRunnerConnector.get(AppsDeviceListActivity.this).j();
                        return;
                    }

                    AppsRunnerConnector.get(AppsDeviceListActivity.this).maybe_IsCurrentConnectingDevice(v1);
                }
            });
