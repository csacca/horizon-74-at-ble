...
public class AppsHistoryPhoneActivity extends AppsRootActivity implements View.OnTouchListener {
    ...
    public AppsHistoryPhoneActivity() {
        this.j = false;
        this.k = false;
        this.l = false;
        this.m = null;
        ...
        this.J = false;
        this.K = null;
        this.N = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker arg6, int arg7, int arg8, int arg9) {
                ...
                if(v7_1.getTime() > AppsHistoryPhoneActivity.a(AppsHistoryPhoneActivity.this).getTime()) {
                    String v8_3 = b.a().d(AppsHistoryPhoneActivity.this);
                    AppsHistoryPhoneActivity.b(AppsHistoryPhoneActivity.this).setText(f.a(v7_1, "MMMM dd,yyyy", v8_3));
                    Date v0 = f.stringToDate(v6_1, "yyyy/MM/dd");
                    AppsHistoryPhoneActivity.a(AppsHistoryPhoneActivity.this, v0);
                    AppsHistoryPhoneActivity.c(AppsHistoryPhoneActivity.this).setText(f.a(v7_1, "MMMM dd,yyyy", v8_3));
                    Date v6_2 = f.stringToDate(v6_1, "yyyy/MM/dd");
                    AppsHistoryPhoneActivity.b(AppsHistoryPhoneActivity.this, v6_2);
                }
                else {
                    String v8_4 = b.a().d(AppsHistoryPhoneActivity.this);
                    AppsHistoryPhoneActivity.b(AppsHistoryPhoneActivity.this).setText(f.a(v7_1, "MMMM dd,yyyy", v8_4));
                    Date v6_3 = f.stringToDate(v6_1, "yyyy/MM/dd");
                    AppsHistoryPhoneActivity.a(AppsHistoryPhoneActivity.this, v6_3);
                }

                AppsHistoryPhoneActivity.d(AppsHistoryPhoneActivity.this);
            }
        };
        this.O = new DatePickerDialog.OnDateSetListener() {
            @Override  // android.app.DatePickerDialog$OnDateSetListener
            public void onDateSet(DatePicker arg6, int arg7, int arg8, int arg9) {
                StringBuilder v6 = new StringBuilder();
                v6.append(arg7);
                ...
                String v6_1 = v6.toString();
                Date v7_1 = f.stringToDate(v6_1, "yyyy/MM/dd");
                Date v8_2 = AppsHistoryPhoneActivity.e(AppsHistoryPhoneActivity.this);
                Date v9 = f.stringToDate("2116/01/01", "yyyy/MM/dd");
                if(v7_1.getTime() < v8_2.getTime()) {
                    v7_1 = v8_2;
                }
        ...
        this.P = new BroadcastReceiver() {
            ...
            public void onReceive(Context arg2, Intent arg3) {
                ...
                if(v2.equals("NOTIFICATION_DID_START_WORKOUT")) {
                    AppsRunner.get(AppsHistoryPhoneActivity.this).u();
                ...
                if(!v2.equals("NOTIFICATION_DIDCONNECT") && !v2.equals("NOTIFICATION_DISCONNECT")) {
                    if(v2.equals("NOTIFICATION_SYN_USER_INFO_FINISH")) {
                        if(!AppsHistoryPhoneActivity.f(AppsHistoryPhoneActivity.this)) {
                            return;
                        }

                        AppsHistoryPhoneActivity.this.b(false);
                        AppsHistoryPhoneActivity.this.i.removeMessages(0x6F);
                        AppsRunner.get(AppsHistoryPhoneActivity.this).u();
                        if(AppsHistoryPhoneActivity.g(AppsHistoryPhoneActivity.this) != null) {
                            AppsHistoryPhoneActivity.this.onBackPressed();
                            Intent v2_1 = new Intent();
                            v2_1.setAction("NOTIFICATION_HISTORY_HOME");
                            AppsHistoryPhoneActivity.this.sendBroadcast(v2_1);
                            return;
                        }
                ...
                AppsHistoryPhoneActivity.f(AppsHistoryPhoneActivity.this);
            }
        };
        this.i = new Handler() {
            ...
            public void handleMessage(Message arg4) {
                if(arg4.what == 0x6F) {
                    Intent v4 = new Intent(AppsHistoryPhoneActivity.this, AppsDeviceListPhoneActivity.class);
                    AppsHistoryPhoneActivity.this.startActivity(v4);
    ...
    static Date a(AppsHistoryPhoneActivity arg0) {
        return arg0.G;
    }

    static Date a(AppsHistoryPhoneActivity arg0, Date arg1) {
        arg0.F = arg1;
        return arg1;
    }

    public void a(int arg28, boolean arg29) {
        AppsHistoryPhoneActivity v15 = this;
        ...
        int v15_1 = v20;
        int v14_1 = v21;
        AppsHistoryPhoneActivity v1_2 = this;
        if(v5 > 0 && !d.strNotEmpty(v3)) {
            ...
            if(!d.a(v3, "0000000000000000000000000000000000000000")) {
                ...
                m.a(new a() {
                    @Override  // apps.c.m$a
                    public Object a() {
                        String v0 = o.a().a(AppsHistoryPhoneActivity.this, "55xtz5n5kmdphxxsmbvgn68byrvnqbxj", "t8WV9adqUT6D47yvqd9gFu65MZUFcNKWtNwC9GCHJG6", v3, ((int)AppsRunner.get(this).inclineSupportsHalfDegree(v1_2)), v0_1);
                        if(!d.strNotEmpty(v0)) {
                        ...
                        if(arg8 != null) {
                            try {
                                ...
                                label_20:
                                    ...
                                    c.a().a(AppsHistoryPhoneActivity.this, v15_1 + "", v2_1);
                                    j.a("====", "等MMF refresh token，先保存到本地MMF : " + v8_1);
                                    ((AppsApplication)AppsHistoryPhoneActivity.this.getApplication()).doRefreshMMFToken2(v15_1 + "", 1);
                                    return;
                                }
                            }
                            catch(Exception v8) {
                    ...
                    label_96:
                        if(v0 == 0) {
                            if(arg28 < 999) {
                                ...
                                AppsHistoryPhoneActivity.this.a(arg28 + 1, arg29);
                                return;
                            }
                            ...
                            if(arg29) {
                                String v0_1 = AppsHistoryPhoneActivity.this.getResources().getString(0x7F0B00BF);  // string:STR_SHARE_SUCCESS "Successfully Shared"
                                AppsHistoryPhoneActivity.this.b(v0_1);
                                return;
                            }
                        }
                    }
    ...
    static Button b(AppsHistoryPhoneActivity arg0) {
        return arg0.t;
    }

    static Date b(AppsHistoryPhoneActivity arg0, Date arg1) {
        arg0.G = arg1;
        return arg1;
    }
    ...
    public void b(int arg23, boolean arg24) {
        ...
        if(v10 > 0 && v0 > 0 && !d.strNotEmpty(v9) && !d.a(v9, "")) {
            ...
            m.a(new a() {
                @Override  // apps.c.m$a
                public Object a() {
                    String v0 = o.a().a(AppsHistoryPhoneActivity.this, "afgfitness", "c7e6915ed48f7befbaa3", v9, ((int)v11), v12, v8, v15_1);
                    if(!d.strNotEmpty(v0)) {
                        AppsArticle v1 = AppsArticle.toAppsArticle(v0);
                        if(v1 != null) {
                            v1.setJson(v0);
                    ...
                    if(arg8 != null) {
                        try {
                            ...
                            if(d.b(v8_1.getJson()).indexOf("Expired token") != -1) {
                                ...
                                v2_1.setUnits(v12);
                                v2_1.setUserid(v13 + "");
                                c.a().a(AppsHistoryPhoneActivity.this, v13 + "", v2_1);
                                j.a("====", "等MFP refresh token，先保存到本地MFP : " + v8_1);
                                ((AppsApplication)AppsHistoryPhoneActivity.this.getApplication()).doRefreshMFPToken2(v13 + "", 1);
                                return;
                            }
                ...
                label_85:
                    if(v0 == 0) {
                        if(arg23 < 999) {
                            ...
                            AppsHistoryPhoneActivity.this.b(arg23 + 1, arg24);
                            return;
                        }
    ...
    static Button c(AppsHistoryPhoneActivity arg0) {
        return arg0.u;
    }
    ...
    public void c(int arg23, boolean arg24) {
        ...
        if(v6 > 0.0f && v10 > 0 && v0 > 0 && !d.strNotEmpty(v9) && !d.a(v9, "")) {
            int v18 = v0 >= 60 ? v0 : 60;
            ...
            m.a(new a() {
                @Override  // apps.c.m$a
                public Object a() {
                    String v0 = o.a().b(AppsHistoryPhoneActivity.this, "227WN7", "2a036801e9f03a1186a4204415354c90", v9, ((int)v11), v12, v8, v15_1);
                    if(!d.strNotEmpty(v0)) {
                        AppsArticle v1 = AppsArticle.toAppsArticle(v0);
                        if(v1 != null) {
                            v1.setJson(v0);
                    ...
                    if(arg8 != null) {
                        try {
                            ...
                            label_24:
                                ...
                                ((AppsApplication)AppsHistoryPhoneActivity.this.getApplication()).doRefreshFBToken2(v13 + "", 1);
                                return;
                            }
                        }
                        catch(Exception v8) {
                ...
                label_94:
                    if(v0 == 0) {
                        if(arg23 < 999) {
                            ...
                            AppsHistoryPhoneActivity.this.c(arg23 + 1, arg24);
                            return;
                        }
    ...
    static void d(AppsHistoryPhoneActivity arg0) {
        arg0.p();
    }

    static Date e(AppsHistoryPhoneActivity arg0) {
        return arg0.F;
    }
    ...
    public void e() {
        ...
        n.a().e(this, 0x7F0702E2).setText(this.getResources().getString(0x7F0B00E8));  // id:tv_unit_maxHeartRate
        ...
        n.a().e(this, 0x7F0702C6).setText(this.getResources().getString(0x7F0B0107));  // id:tv_title
        String v0 = b.a().d(this);
        this.t.setText(f.a(this.F, "MMMM dd,yyyy", v0));
        this.u.setText(f.a(this.G, "MMMM dd,yyyy", v0));
        this.o();
    }

    static boolean f(AppsHistoryPhoneActivity arg0) {
        return arg0.J;
    }
    ...
    static String g(AppsHistoryPhoneActivity arg0) {
        return arg0.K;
    }
    ...
    public void l() {
        ...
        v0.setTime(this.F);
        this.L = new DatePickerDialog(this, this.N, v0.get(1), v0.get(2), v0.get(5));
        this.L.show();
    }
    ...
    public void m() {
        Calendar v0 = Calendar.getInstance();
        v0.setTime(this.G);
        this.M = new DatePickerDialog(this, this.O, v0.get(1), v0.get(2), v0.get(5));
        this.M.show();
    }
    ...
    private void n() {
        ...
        this.D = n.a().c(this, 0x7F07019E);  // id:rv_history
        this.E = n.a().d(this, 0x7F0700DB);  // id:iv_history
        this.Q = n.a().c(this, 0x7F070176);  // id:noBluetoothLayout
        String v0 = b.a().d(this);
        this.t.setText(f.a(this.F, "MMMM dd,yyyy", v0));
        this.u.setText(f.a(this.G, "MMMM dd,yyyy", v0));
        ...
        int v0_1 = d.a(this);
        float v1 = (float)v0_1;
        LinearLayout.LayoutParams v3 = (LinearLayout.LayoutParams)this.D.getLayoutParams();
        v3.height = (int)(0.259375f * v1);
        v3.width = v0_1;
        this.D.setLayoutParams(v3);
        int v0_2 = (int)(v1 / 320.0f * 70.0f);
        LinearLayout.LayoutParams v1_1 = (LinearLayout.LayoutParams)this.E.getLayoutParams();
        v1_1.width = v0_2;
        v1_1.height = v0_2;
        this.E.setLayoutParams(v1_1);
    }
    ...
    public void onCreate(Bundle arg6) {
        ...
        this.setContentView(0x7F090027);  // layout:activity_history_phone
        if(this.getIntent().getExtras() != null) {
            if(this.getIntent().getExtras().get("shouldStopSafetyKeyTip") != null) {
                this.I = ((Boolean)this.getIntent().getExtras().get("shouldStopSafetyKeyTip")).booleanValue();
            }
            ...
            if(this.getIntent().getExtras().get("Extra_Key_from") != null) {
                this.K = (String)this.getIntent().getExtras().get("Extra_Key_from");
            }
            ...
            if(!d.strNotEmpty(this.m)) {
                this.F = f.stringToDate(this.m, "yyyy-MM-dd HH:mm:ss");
                this.G = f.stringToDate(this.m, "yyyy-MM-dd HH:mm:ss");
            }
        }
    ...
    private void p() {
        ...
        double v9_1;
        double v3;
        AppsHistoryPhoneActivity v6 = this;
        int v7 = AppsRunner.get(this).getPref_CurrentUserID(v6);
        String v0 = v6.H ? "yyyy-MM-dd HH:mm:ss" : "yyyy-MM-dd";
        if(!v6.j && !v6.l) {
            v0 = "yyyy-MM-dd";
        }
        ...
        String v8 = f.a(v6.F, v0);
        String v9 = f.a(v6.G, v0);
