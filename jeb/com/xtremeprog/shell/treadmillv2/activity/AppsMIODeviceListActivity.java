...
public class AppsMIODeviceListActivity extends AppsRootActivity implements View.OnTouchListener, AdapterView.OnItemClickListener {
    ...
    public AppsMIODeviceListActivity() {
        this.o = null;
        this.p = null;
        this.q = false;
            ...
            public void onReceive(Context arg2, Intent arg3) {
                ...
                if(!v2.equals("NOTIFICATION_MIO_DID_FIND_DEVICE") && (!v2.equals("NOTIFICATION_STATE_MIO_DIDCONNECTSTATE") && !v2.equals("NOTIFICATION_MIO_DIDCONNECT") && !v2.equals("NOTIFICATION_MIO_DISCONNECT") && !v2.equals("NOTIFICATION_STATE_MIO_DIDCONNECT") && !v2.equals("NOTIFICATION_REFRESH_MIO_DEVICE_LIST_DATA"))) {
                    if(v2.equals("NOTIFICATION_DIDCONNECT")) {
                        AppsMIODeviceListActivity.b(AppsMIODeviceListActivity.this);
                        return;
                    }

                    if(v2.equals("NOTIFICATION_DISCONNECT")) {
                        if(!AppsMIODeviceListActivity.b(AppsMIODeviceListActivity.this)) {
                            return;
                        }
                    ...
                    if(v2.equals("NOTIFICATION_SYN_USER_INFO_FINISH")) {
                        ...
                        AppsMIODeviceListActivity.this.i.removeMessages(0x6F);
                        Intent v0 = AppsMIODeviceListActivity.this.getIntent();
                        AppsMIODeviceListActivity.this.setResult(-1, v0);
                ...
                AppsMIODeviceListActivity.a(AppsMIODeviceListActivity.this).notifyDataSetChanged();
            }
        };
        this.i = new Handler() {
            ...
            public void handleMessage(Message arg4) {
                if(arg4.what == 0x6F) {
                    Intent v4 = new Intent(AppsMIODeviceListActivity.this, AppsDeviceListActivity.class);
                    AppsMIODeviceListActivity.this.startActivity(v4);
    ...
    static c a(AppsMIODeviceListActivity arg0) {
        return arg0.n;
    }
    ...
    static boolean b(AppsMIODeviceListActivity arg0) {
        return arg0.q;
    }
    ...
    public void onCreate(Bundle arg3) {
        ...
        this.a(0x7F090029, 0x7F09002A, 0x7F09002B);  // layout:activity_mio_device_list
            ...
            v3.a(this.getResources().getString(0x7F0B000A), new DialogInterface.OnClickListener() {  // string:STR_ALERT_TIP_CONFIRM "Yes"
                ...
                public void onClick(DialogInterface arg1, int arg2) {
                    ...
                    if(((boolean)(((int)v2)))) {
                        ...
                        AppsRunnerConnector.get(AppsMIODeviceListActivity.this).maybe_onMIODisconnect();
                        return;
                    }

                    AppsRunnerConnector.get(AppsMIODeviceListActivity.this).maybe_IsCurrentConnectingMIODevice(v1);
                }
            });
