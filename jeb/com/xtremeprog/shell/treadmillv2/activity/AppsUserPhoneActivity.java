...
public class AppsUserPhoneActivity extends AppsRootActivity implements View.OnTouchListener {
    ...
    public AppsUserPhoneActivity() {
        ...
        this.i = new Handler() {
            ...
            public void handleMessage(Message arg4) {
                if(arg4.what == 0x6F) {
                    Intent v4 = new Intent(AppsUserPhoneActivity.this, AppsDeviceListPhoneActivity.class);
                    AppsUserPhoneActivity.this.startActivity(v4);
                ...
                if(!v3.equals("NOTIFICATION_DIDCONNECT")) {
                    if(!v3.equals("NOTIFICATION_SYN_USER_INFO_FINISH")) {
                        if(v3.equals("NOTIFICATION_DISCONNECT")) {
                            AppsUserPhoneActivity.a(AppsUserPhoneActivity.this);
                            return;
                        }
                        ...
                        if(!v3.equals("NOTIFICATION_DID_GET_USER")) {
                            ...
                            if(v3.equals("NOTIFICATION_START_SYN_USER_INFO")) {
                                AppsUserPhoneActivity.this.i.removeMessages(0x6F);
                                return;
                            }

                            if(!v3.equals("NOTIFICATION_DID_SET_USER_DATA")) {
                                if(v3.equals("NOTIFICATION_CANCEL_SELECT_USER_LOADING")) {
                                    if(AppsUserPhoneActivity.a(AppsUserPhoneActivity.this)) {
                                        new Handler().postDelayed(new Runnable() {
                                            @Override
                                            public void run() {
                                ...
                                else if((v3.equals("NOTIFICATION_SHOW_SELECT_USER_LOADING_WHEN_RESEND")) && (AppsUserPhoneActivity.a(AppsUserPhoneActivity.this))) {
                                    AppsUserPhoneActivity.this.a(AppsUserPhoneActivity.this, "", false);
                                    return;
                                    AppsUserPhoneActivity.this.finish();
                                    return;
                                }
                    ...
                    else if(AppsUserPhoneActivity.a(AppsUserPhoneActivity.this)) {
                        AppsUserPhoneActivity.this.a(false);
                        AppsUserPhoneActivity.this.i.removeMessages(0x6F);
        ...
        this.j = new Handler() {
            ...
            public void handleMessage(Message arg1) {
                AppsRunner.get(AppsUserPhoneActivity.this.getApplicationContext()).clear();
    ...
    private void a(int arg7) {
        TextView v7_1;
        TextView v7;
        UserArticle v0 = (UserArticle)this.I.get(arg7);
    ...
    static boolean a(AppsUserPhoneActivity arg0) {
        return arg0.M;
    }
    ...
    static Date b(AppsUserPhoneActivity arg0) {
        return arg0.O;
    }
    ...
    private void b(int arg13) {
        ...
        for(v1 = 0; v1 < this.I.size(); ++v1) {
            Button v2 = (Button)this.J.get(v1);
            TextView v3 = (TextView)this.K.get(v1);
            UserArticle v4 = (UserArticle)this.I.get(v1);
    ...
    public void e() {
        ...
        n.a().e(this, 0x7F0702C6).setText(this.getResources().getString(0x7F0B00BD));  // id:tv_title
        if(this.P == 0) {
    ...
    public void l() {
        ...
        new Thread() {
            @Override
            public void run() {
                AppsRunner.get(AppsUserPhoneActivity.this.getApplicationContext()).a(AppsUserPhoneActivity.this.getApplicationContext(), AppsUserPhoneActivity.b(AppsUserPhoneActivity.this));
                Message v0 = new Message();
                AppsUserPhoneActivity.this.j.sendMessage(v0);
            }
        }.start();
    }
    ...
    private void n() {
        ...
        this.H = n.a().c(this, 0x7F07019E);  // id:rv_history
        this.J.add(this.k);
        this.J.add(this.l);
        this.J.add(this.m);
        this.J.add(this.n);
        ...
        this.K.add(this.v);
        int v0 = d.a(this);
        RelativeLayout.LayoutParams v2 = (RelativeLayout.LayoutParams)this.H.getLayoutParams();
        v2.height = (int)(((float)v0) * 0.259375f);
        v2.width = v0;
        this.H.setLayoutParams(v2);
        this.G.setVisibility(8);
    }

    private void o() {
        this.L = AppsRunner.get(this).getPref_CurrentUserID(this);
    ...
    public void onCreate(Bundle arg6) {
        ...
        this.setContentView(0x7F090066);  // layout:activity_user_phone
        this.n();
        this.b(true);
        AppsApplication v0 = (AppsApplication)this.getApplication();
        v0.g(false);
    ...
    public boolean onTouch(View arg6, MotionEvent arg7) {
        ...
        if(arg7.getAction() == 0) {
            if(arg6 == this.k) {
                ...
                j.a("===", "==切换用户：" + this.P);
                this.b(this.P);
                AppsRunner.get(this).a(this, this.P);
                this.L = AppsRunner.get(this).getPref_CurrentUserID(this);
            ...
            if(arg6 != this.C && arg6 != this.D) {
                ...
                if(arg6 == this.A) {
                    ...
                    v6_4 = new Intent(this, AppsUserEditPhoneActivity.class);
                    v6_4.putExtra("Extra_Key_editUser", ((Serializable)this.I.get(this.L)));
                    this.startActivityForResult(v6_4, 0x6F);
                    return true;
                }

                if(arg6 == this.B) {
                    v6_4 = new Intent(this, AppsHistoryPhoneActivity.class);
